...
const PropertyDetails = () => {
  ...
  return (
  <section>
    <div className='container mx-auto min-h-[800px] pt-28 mb-14 '>
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='mb-4 lg:mb-0 flex gap-x-2 text-sm'>
          ...
          <div className='bg-violet-500 text-white px-3 rounded-full'>{house.address}</div>
        </div>
      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        <div className='max-w-[768px]'>
          <div className='mb-8 border'>
            <ImageSlider className='w-full h-full' slides={house.slides}/>
          </div>
          ...
          <div className='m-0'>
            <div className='mt-8 mb-6'>
              <p className='max-w-[45em]'>{house.description}</p>
            </div>
            <div className=' border-t-2 m-0 border-b-violet-400 border-t-violet-400  border-solid 
